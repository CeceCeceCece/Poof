...
namespace UnitTests
{
    public class VolcanicCardLogicTest
    {
        ...
        public async Task ActivateAsyncTest()
        {
            ...
            var cardLogic = Creator.GetCard("Volcanic").Map();
            ...
            Assert.Equal(BangState.WeaponAll, character.Character.BangState);
        }
        ...
        public async Task DeActivateAsyncTest()
        {
            ...
            Assert.Equal(BangState.One, character.Character.BangState);
        }
